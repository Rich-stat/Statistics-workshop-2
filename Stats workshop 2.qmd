...
<br> **1. Download the Excel file *1-Factor_ANOVA_cholesterol.xlsx* from Canvas**

::: {.callout-note collapse="true" title="Click guidance notes" icon="true"}
...
-   In RStudio, locate the file and set the location as your working directory. <br> If you are using a University computer you can locate OneDrive by typing: `setwd("O:/")`.<br><br> Then click the 'More' cog icon and select 'Go to working directory' and find your folder - set that as your final working directory.
:::
...
<br><br> `5.` **THE ANOVA ANALYSIS:** <br>`5.1` **IF THE DATA IS NORMALLY DISTRIBUTED & THE VARIANCES ARE HOMOGENEOUS**<br> <br> **The ANOVA:**
...
<br> <br> <br> `5.2` **IF THE DATA IS NORMALLY DISTRIBUTED & THE VARIANCES ARE NOT HOMOGENEOUS** <br> **The ANOVA:**
...
<br><br> <br>`5.3` **IF THE DATA IS NOT NORMALLY DISTRIBUTED** <br> **Kruskal-Wallis test:**
...
-   In RStudio, locate the file and set the location as your working directory. <br> If you are using a University computer you can locate OneDrive by typing: `setwd("O:/")`. <br> Then click the 'More' cog icon and select 'Go to working directory' and find your folder - set that as your final working directory.
:::
...
-   In RStudio, locate the file and set the location as your working directory. <br> If you are using a University computer you can locate OneDrive by typing: `setwd("O:/")`.<br><br>
...
<br> View the 1st 6 rows of the dataframe:
...
The data is tidy: each row represents a person and each column is a different variable.
:::
...
<br><br> **5. THE REPEATED MEASURES ANOVA** <br><br>`5.1` **IF THE DATA IS NORMALLY DISTRIBUTED** <br> `5.1a` **Repeated measures ANOVA**, including Mauchly's Sphericity test<br>
...
<br><br><br> `5.2`. **IF THE DATA IS NOT NORMALLY DISTRIBUTED: THE FRIEDMAN TEST** <br> `5.2a` **The Friedman test**
...
<br><br> `3.` **Explore the data** <br>
`3a.` **Descriptive statistics**<br>
<br> First, get summary descriptive statistics for Cholesterol grouped by treatment Group:
...
<br>
<br>`4.` **Check assumptions of ANCOVA:**<br> `A.` Check relationship of covariate (Age) and outcome (Cholesterol) is linear in the 3 groups:
...
ancova_chol |> 
  ...
  kable(align = 'l')
```
Here, the Group:Age interaction term P = 0.659.<br><br>
*NB* 'pes' = partial eta squared effect size:<br> eta^2^ of 0.01 = small effect,<br>eta^2^ of 0.06 = medium effect,<br>eta^2^ of 0.14 = large effect.
:::
...
df_ancov |>
  kable(align = 'l')
```
*NB* 'pes' = partial eta squared effect size:<br> eta^2^ of 0.01 = small effect,<br>eta^2^ of 0.06 = medium effect,<br>eta^2^ of 0.14 = large effect.<br>
<br> The statistical significance (P) of the effect of Group on Cholesterol is 1.58 x 10^-16^ when the effect of age is removed (Without removing age, the effect of group was P = 8 x 10^-7^; see 1-Factor ANOVA tab section 5.1).
:::
...
<br>Here, The Control and Drug_1 and the Drug_1 and Drug_2 cholesterol levels are significantly different. The Drug_2 group is not sig different to the Control group.
:::
