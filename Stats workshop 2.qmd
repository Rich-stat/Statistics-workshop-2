...
<br><br><br> **5.2 Multiple comparison test:**<br> Compares every group with every other group.<br><br>
`5.2a` If variances in the 2 factors are equal (`4.2` above)<br>
Use the **Tukey HSD** multiple comparison test.<br> 
...
<br>
`5.2b` If homogeneity of variance is NOT true (`4.2` above), use the **Games-Howell** multiple comparison test:<br><br>
