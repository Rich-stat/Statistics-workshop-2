...
By default, the x-values are plotted in alphabetical and numerical order. Use the `fct_relevel()` function to specify the order of the x-values if you want to change this. <br>In these plots *Group* is the main variable placed on the x-axis.<br><br>
a) for this boxplot, use:<br>
`anova_1_factor$Group <- fct_relevel(anova_1_factor$Group, "Control", "Drug_1", "Drug_2")`<br>
<br>
b) for this barplot, use:<br>
`anova_mean_table$Group <- fct_relevel(anova_mean_table$Group, "Control", "Drug_1", "Drug_2")`
:::
...
By default, the x-values are plotted in alphabetical and numerical order. Use the `fct_relevel()` function to specify the order of the x-values if you want to change this. <br>In these plots *Group* is the main variable placed on the x-axis.<br><br>
a) for this boxplot, use:<br>
`aov_2_factor$Group <- fct_relevel(aov_2_factor$Group, "Control", "Drug_1", "Drug_2")`<br>
<br>
b) for this barplot, use:<br>
`anova_table_2$Group <- fct_relevel(anova_table_2$Group, "Control", "Drug_1", "Drug_2")`
:::
